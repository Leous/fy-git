...
function setcity(provinceid, cityid) {
    ...
    switch (province) {
        ...
        case "河南" :
            ...
            break;
        case "香港" :
            var cityOptions = ["香港", "香港",
            "九龙", "九龙",
            "新界", "新界"];
            break;
        case "湖北" :
            var cityOptions = ["武汉(*)", "武汉",
            "恩施", "恩施",
            "鄂州", "鄂州",
            "黄冈", "黄冈",
            "黄石", "黄石",
        ...
        case "辽宁" :
            ...
            break;
        case "澳门" :
            var cityOptions = ["澳门", "澳门"];
            break;
        case "内蒙古" :
            var cityOptions = ["呼和浩特(*)", "呼和浩特",
            "阿拉善盟", "阿拉善盟",
            "包头", "包头",
            "赤峰", "赤峰",
            "东胜", "东胜",
